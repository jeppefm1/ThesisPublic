function [proj_lg, geo, angles, scanType] = VarianDataLoaderOwn(datafolder, varargin)
...
%% Load geometry
[geo, ScanXML,ReconXML, scanType] = GeometryFromXMLOwn(datafolder);
...
clear proj Blk Sec airnorm BlkAirNorm;
